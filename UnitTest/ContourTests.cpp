...
namespace ContourTests
{
    ...
    public:
        ...
        TEST_METHOD(TriangulateAndContourMathematicaTests)
        {
            ...
            // read a JSON file
            std::ifstream file(
                "C:\\Users\\Aiden McIlraith\\Documents\\GitHub\\st-visualizer\\UnitTest\\singleContourTest.json");
            auto a = file.is_open();
            ...
            for(auto j : j2)
            {
                ...
                {
                    tris.reserve(delaunay.numberoftriangles);
                    for(int i = 0; i < delaunay.numberoftriangles; ++i)
                    {
                        tris.push_back(getTriangleCornerIndices(delaunay, i));
                    }
                }
            ...
            std::ofstream f(
                "C:\\Users\\Aiden McIlraith\\Documents\\GitHub\\st-visualizer\\UnitTest\\singleContourResults.json");
            f << ret2;
        }
