...
//Refine Grid
std::pair<Eigen::Vector2f, Eigen::Vector2f> refineGrid(Eigen::Matrix2Xf pts,
                                                       std::pair<Eigen::Vector2f, Eigen::Vector2f> grid,
                                                       std::pair<std::vector<int>, Eigen::Matrix2Xi> inliers);

std::pair<std::pair<Eigen::Vector2f, Eigen::Vector2f>, Eigen::Matrix2Xi>
getGridAndCoords(Eigen::Matrix2Xf pts, int num);
